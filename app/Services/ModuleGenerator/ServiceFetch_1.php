...
class ServiceFetch extends Base
{
    ...
    public function generate(): void
    {
        ...
        $viewData = [
            'orderAttr' => !empty($this->model['parentModelConf']['order']['attr'])
                ? $this->model['parentModelConf']['order']['attr'] 
                : 'id',
            'orderDir' => !empty($this->model['parentModelConf']['order']['dir'])
                ? $this->model['parentModelConf']['order']['dir'] 
                : 'ASC',
            'model' => $this->model,
