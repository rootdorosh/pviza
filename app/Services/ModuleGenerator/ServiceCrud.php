 ...
 * class ServiceCrud
 */
class ServiceCrud extends Base
{
    /*
     * @return void
     */
    public function generate(): void
    {
        ...
        $this->gs->putFile($this->getPath(), 
            view()->file($this->gs->getViewBasePath() . 'services/crud.blade.php', $viewData)->render());
    }
    ...
    {
        $namespace = 'App\Modules\\' . $this->gs->config['module']['name'] . '\Services\Crud';
    ...
    public function getPath(): string
    {
        ...
        $path.= '/' . $this->model['name'] . 'CrudService';
