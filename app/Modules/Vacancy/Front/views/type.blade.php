<section class="section breadcrumbs-custom breadcrumbs-custom-overlay-4">
    <div class="breadcrumbs-custom-main bg-image bg-gray-700" style="background-image: url({!! $type->getThumb('image') !!});">
        <div class="container">
...
<section class="section section-md">
    <div class="container">
        <?= $widget->view('_search', compact('type'))?>
        <div class="row row-50 flex-lg-row-reverse">
            ...
            <div class="col-lg-4 col-xl-3">
                <div class="row row-30">
                    <?= $widget->view('_filter', compact('type'))?>
                </div>
            </div>
        </div>
    </div>
