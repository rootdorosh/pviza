...
export default {
  name: 'VacancyTypeForm',
  components: { FormFooter, ImageBase64 },
  computed: {
    ...mapState('vacancyTypeForm', {
  ...
  methods: {
    ...mapMutations('vacancyTypeForm', ['setState']),
    ...mapActions('vacancyTypeForm', ['onMeta', 'onSubmit', 'onCancel', 'onSaveExit', 'onRouteId']),
  },
  created() {
    this.onRouteId()
    this.onMeta()
