...
export default {
  name: 'VacancyCategoryForm',
  components: { FormFooter, ImageBase64 },
  computed: {
    ...mapState('vacancyCategoryForm', {
  ...
  methods: {
    ...mapMutations('vacancyCategoryForm', ['setState']),
    ...mapActions('vacancyCategoryForm', ['onMeta', 'onSubmit', 'onCancel', 'onSaveExit', 'onRouteId']),
  },
  created() {
    this.onRouteId()
    this.onMeta()
