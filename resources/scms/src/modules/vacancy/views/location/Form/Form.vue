...
export default {
  name: 'VacancyLocationForm',
  components: { FormFooter, ImageBase64 },
  computed: {
    ...mapState('vacancyLocationForm', {
  ...
  methods: {
    ...mapMutations('vacancyLocationForm', ['setState']),
    ...mapActions('vacancyLocationForm', ['onMeta', 'onSubmit', 'onCancel', 'onSaveExit', 'onRouteId']),
  },
  created() {
    this.onRouteId()
    this.onMeta()
