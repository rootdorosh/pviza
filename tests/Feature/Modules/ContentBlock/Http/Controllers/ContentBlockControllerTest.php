 ...
 * 
 * @group  contentBlock.contentBlock
 */
class ContentBlockControllerTest extends TestCase
{
    ...
    {       
        ...
        $url = self::BASE_URL . 'content-block/content-blocks/' . $contentBlock->id;
        $path = 'content_block/content_blocks/destroy';       
    ...
    {       
        ...
        $url = self::BASE_URL . 'content-block/content-blocks/bulk-destroy';
        $path = 'content_block/content_blocks/bulk_destroy';       
